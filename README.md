# Laravel 11 - Vinyl Shop starter project

- Clone this repository to the folder **C:\Sites_laravel**  
  `$ git clone https://github.com/pverhaert/laravel11_vinyl_shop_start.git vinyl_shop`
- Open the folder **C:\Sites_laravel\vinyl_shop** in PHPStorm
    - Rename the file **.env.vinylshop** to **.env**
